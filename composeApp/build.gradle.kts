...
kotlin {
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation("app.cash.sqldelight:coroutines-extensions:${libs.versions.sqlDelightCoroutines.get()}") // Add this line
        }
...
sqldelight {
    databases {
        create("GroceryDatabase") {
            packageName.set("org.example.fridgital.database")
        }
    }
}
